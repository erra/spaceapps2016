...
//          infowindow.setContent(locations_alert[i][0]);
          infowindow.setContent(load_content(marker, locations_alert[i][0], locations_alert[i][1], locations_alert[i][2]));		  
...
function load_content(marker, id , la, lo){
//		alert(la + " ___ " + lo);
  $.ajax({
    url: 'sonda.php?sonda=' + id + '&la='+ la + '&lo='+lo,
