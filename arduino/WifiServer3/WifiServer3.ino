...
void loop() {
  ...
  if (req.indexOf("/engines/") != -1) {
    ...
    client.print("<title>SERVIDOR WIFI</title>");
    client.print("</head><body>");
    client.print("<script type='text/javascript' src='http://192.168.1.196/arduino/js/wifi_car.js'></script>");
    client.print("<a href='#' onclick='move(\"f\");'>AVANZAR</a><BR/>");
    client.print("<a href='#' onclick='move(\"b\");'>RETROCEDER</a><BR/>");
    client.print("<a href='#' onclick='move(\"l\");'>IZQUIERDA</a><BR/>");
    client.print("<a href='#' onclick='move(\"r\");'>DERECHA</a><BR/>");
